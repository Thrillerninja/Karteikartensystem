...
By default, when a mock method is invoked, gMock will searchNode the expectations in
...
{: .callout .note}
**Note:** Why does gMock searchNode for a match in the *reverse* order of the
